...
public class AlkalmazottatHasznalo {
	...
	public static void main(String[] args) {
		...
		Alkalmazott masik_alkalmazott = new Alkalmazott("Kiss Klaudia", 60);
 ...
 */			
		...
		for (int i = 0; i < alkalmazottak.length; i++) {
			...
			alkalmazottak[i] = new Alkalmazott(nev, (long)(Math.random() * 100));
